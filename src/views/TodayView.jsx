              ...
              {expandedMeal === i && (
                <div style={{ padding: "10px 0 10px 34px", borderBottom: i < MEALS.length - 1 ? `1px solid ${C.structBorder}` : "none" }}>
                  ...
                  <div style={{ display: "flex", gap: 6 }}>
                    <button onClick={() => showToast?.("Photo logging coming soon")} style={{ flex: 1, padding: "8px 10px", background: C.structGlass, border: `1px solid ${C.structBorderHover}`, borderRadius: 6, color: C.text3, fontSize: 9, fontFamily: "var(--m)", cursor: "pointer", letterSpacing: ".08em", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, minHeight: 36 }}>
                    ...
                    <button onClick={() => showToast?.("Barcode scanning coming soon")} style={{ flex: 1, padding: "8px 10px", background: C.structGlass, border: `1px solid ${C.structBorderHover}`, borderRadius: 6, color: C.text3, fontSize: 9, fontFamily: "var(--m)", cursor: "pointer", letterSpacing: ".08em", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, minHeight: 36 }}>
